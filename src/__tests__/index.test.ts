  ...
  describe("given /tokenInfo endpoint", () => {
    ...
    describe("when called", () => {
      it("returns TokenInfo object", async () => {
        ...
        expect(tokenInfo.entries.GRL.bridgeAddress).toEqual(
          "0xba285A8F52601EabCc769706FcBDe2645aa0AF18"
        );
        ...
        expect(tokenInfo.entries.RPS.bridgeAddress).toEqual(
          "0x8aD93d65FFe170d0d72F7682d6E9Caf0F1A4c03d"
        );
        ...
        expect(tokenInfo.entries.TRX.bridgeAddress).toEqual(
          "TWU3j4etqPT4zSwABPrgmak3uXFSkxpPwM"
        );
