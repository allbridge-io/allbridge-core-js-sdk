...
export class UQ64_64 implements StructClass {
  ...
  static get $typeName() {
    return `${PKG_V13}::uq64_64::UQ64_64`;
  }
  ...
  private constructor(typeArgs: [], fields: UQ64_64Fields) {
    this.$fullTypeName = composeSuiType(UQ64_64.$typeName, ...typeArgs) as string;
  ...
  static reified(): UQ64_64Reified {
    return {
      ...
      fullTypeName: composeSuiType(UQ64_64.$typeName, ...[]) as string,
      typeArgs: [] as [],
