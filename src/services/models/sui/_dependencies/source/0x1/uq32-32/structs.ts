...
export class UQ32_32 implements StructClass {
  ...
  static get $typeName() {
    return `${PKG_V13}::uq32_32::UQ32_32`;
  }
  ...
  private constructor(typeArgs: [], fields: UQ32_32Fields) {
    this.$fullTypeName = composeSuiType(UQ32_32.$typeName, ...typeArgs) as string;
  ...
  static reified(): UQ32_32Reified {
    return {
      ...
      fullTypeName: composeSuiType(UQ32_32.$typeName, ...[]) as string,
      typeArgs: [] as [],
