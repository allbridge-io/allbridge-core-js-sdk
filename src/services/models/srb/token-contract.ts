...
export class TokenContract {
  ...
  async initialize<R extends ResponseTypes = undefined>(
    { admin, decimal, name, symbol }: { admin: Address; decimal: u32; name: string; symbol: string },
    options: {
      /**
  ...
  async transferFrom<R extends ResponseTypes = undefined>(
    { spender, from, to, amount }: { spender: Address; from: Address; to: Address; amount: i128 },
    options: {
      /**
       * The fee to pay for the transaction. Default: 100.
       */
